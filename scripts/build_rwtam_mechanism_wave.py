...
from ratewall.rwtam.mechanisms import (
...
def main() -> None:
    result = build_mechanism_wave(Path("configs/rwtam/packs"))
    paths = write_mechanism_wave_outputs(result, Path("var/rwtam/scenarios/mechanism_wave"))
    report_path = write_mechanism_wave_report(result, Path("do/rwtam_mechanism_wave_report_20260702.md"))
    print(report_path)
    for table_name in [
