...
def main() -> None:
    ...
    result = build_slr_conditions_experiment(Path("configs/rwtam/packs"))
    paths = write_slr_conditions_outputs(result, Path("var/rwtam/scenarios/slr_conditions"))
    report = write_slr_conditions_report(result, Path("do/rwtam_slr_conditions_report_20260703.md"))
    print(report)
