...
def main() -> None:
    result = build_hysteresis_experiment(Path("configs/rwtas/packs"))
    paths = write_hysteresis_outputs(result, Path("var/rwtas/scenarios/hysteresis_engine_loop"))
    report_path = write_hysteresis_report(result, Path("do/rwtas_migration_engine_loop_report_20260703.md"))
    print(report_path)
    for table_name in [
