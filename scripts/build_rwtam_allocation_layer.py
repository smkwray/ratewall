...
from ratewall.rwtam.allocation_layer import (
...
def main() -> None:
    result = build_allocation_layer(Path("configs/rwtam/packs"))
    paths = write_allocation_layer_outputs(result, Path("var/rwtam/scenarios/allocation_layer"))
    report = write_allocation_layer_report(result, Path("do/rwtam_allocation_fix_report_20260703.md"))
