"""Scenario-only relative-yield allocation layer for RWTAM."""
...
from ratewall.rwtam.data_upgrades import allocation_exact_pull_rows
from ratewall.rwtam.hysteresis import REVERSAL_SHARE_BANDS
from ratewall.rwtam.scenarios import _financialization_config_rows
...
OUTPUT_DIR = Path("var/rwtam/scenarios/allocation_layer")
FIX_REPORT_PATH = Path("do/rwtam_allocation_fix_report_20260703.md")
...
def build_allocation_layer(
    ...
    *,
    ...
    with localcontext() as context:
        ...
        with tempfile.TemporaryDirectory(prefix="rwtam_allocation_layer_") as tmp:
            tmp_root = Path(tmp)
...
def _financialization_interaction_rows(
    ...
    with tempfile.TemporaryDirectory(prefix="rwtam_f_asset_allocation_") as tmp:
        tmp_root = Path(tmp)
        ...
        rows.append(
            {
                ...
                "source": "do/rwtam_allocation_layer_evidence_20260703.md",
            }
        )
    rows.append(
        {
    ...
    return [
        {
            ...
            "source_file": "src/ratewall/rwtam/v1.py:_treasury_yield_delta_bp; owner risky-real baseline delta=0",
        ...
        },
        {
            ...
            "source_file": "do/rwtam_allocation_layer_evidence_20260703.md",
        ...
        },
        {
            ...
            "source_file": "src/ratewall/rwtam/hysteresis.py:REVERSAL_SHARE_BANDS",
        ...
        },
        {
            ...
            "source_file": "configs/rwtam/packs/phase6/conversion_parameters.csv:business_fixed_investment_baseline_annual",
