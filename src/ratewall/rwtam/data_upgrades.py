"""Evidence helpers for the RWTAM historical data-upgrade wire."""
...
from ratewall.rwtam.v1 import _d, _fmt, _read_csv_rows


HISTORICAL_UPGRADE_PACK_DIR = Path("configs/rwtam/packs/historical_upgrades")
        ...
        rows.append(
            {
                ...
                "grade": "A",
                "source": "tdcest raw FRED Z.1 levels; do/rwtam_settlement_class_doctrine_20260703.md",
...
def settlement_class_map_rows(pack_dir: Path = Path("configs/rwtam/packs")) -> list[dict[str, str]]:
    holder_rows = [
        row
        ...
        rows.append(
            {
                ...
                "source": "treasury_holder_matrix.csv; do/rwtam_settlement_class_doctrine_20260703.md",
                "note": note,
            }
        )
    rows.append(
