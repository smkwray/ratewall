...
VALIDATION_REPORT_PATH = Path("do/rwtas_rwpi_plug_validation_report_20260704.md")
...
def write_rwpi_plug_validation_report(
    ...
    lines = [
        "# RWTAS RW_pi plug-validation report",
        "",
        "Date: 2026-07-04.",
    ...
    lines.extend(
        [
            ...
            "",
            "Output CSVs: `var/rwtas/scenarios/rwpi/out_rwpi_plug_validation.csv` and `var/rwtas/scenarios/rwpi/out_rwpi_plug_validation_series.csv`.",
        ]
    )
...
def _score_row(
    ...
    return {
        ...
        "lineage": "do/rwpi_observed/manifest.csv;do/rwtas_rwpi_observed_series_20260704.md",
    }
