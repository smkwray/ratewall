"""Scenario-only fiscal financialization tilt experiment for RWTAS."""
...
from ratewall.rwtas.mechanisms import MIGRATION_BANDS
from ratewall.rwtas.reissuance_policy import PRIMARY_DEFICIT_BASE_PATH
...
EXPERIMENT_ID = "rwtas_fiscal_tilt_20260704"
OUTPUT_DIR = Path("var/rwtas/scenarios/fiscal_tilt")
REPORT_PATH = Path("do/rwtas_fiscal_tilt_report_20260704.md")
...
def write_fiscal_tilt_report(
    ...
    finding = (
        ...
        else "the fiscal-tilt run does not support the thesis-form statement at month 120"
    )
    finding_detail = (
    ...
    lines = [
        "# RWTAS fiscal financialization tilt",
        "",
        "Date: 2026-07-04.",
    ...
    lines.extend(
        [
            ...
            "## Output Locations",
            "",
            "- `var/rwtas/scenarios/fiscal_tilt/out_fiscal_tilt_grid.csv`",
            "- `var/rwtas/scenarios/fiscal_tilt/out_fiscal_tilt_ablation.csv`",
            "- `var/rwtas/scenarios/fiscal_tilt/out_fiscal_tilt_state_path.csv`",
        ]
    )
        ...
        rows.append(
            {
                ...
                "source_engine_record": "src/ratewall/rwtas/v1.py:_monthly_records fiscal_tilt_config",
            }
        )
    return rows
...
def _state_zero_row(
    ...
    return {
        ...
        "claim_grade_label": FISCAL_TILT_LABEL,
        "source_engine_record": "configs/rwtas/packs/opening_stocks.csv",
    }
    ...
    return [
        {
            ...
            "source_file": "src/ratewall/rwtas/v1.py:_fiscal_tilt_flow_bil;configs/rwtas/packs/README.md#Reabsorption-as-re-intermediation",
        ...
        },
        {
            ...
            "source_file": "src/ratewall/rwtas/reissuance_policy.py:PRIMARY_DEFICIT_BASE_PATH",
