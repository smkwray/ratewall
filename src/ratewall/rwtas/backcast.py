"""Diagnostic RWTAS historical backcast builder."""
...
class BackcastResult:
    """CSV-ready RWTAS backcast output tables."""
...
def build_backcast(
    ...
    *,
    ...
    monthly = _monthly_backcast_rows(pack, rate_rows, baseline, anchor_quarter, selected_state)
            ...
            out.append(
                {
                    ...
                    "source_artifact_path": "configs/rwtas/packs/mmf_income_targets_v2/mmf_income_targets_v2.csv",
